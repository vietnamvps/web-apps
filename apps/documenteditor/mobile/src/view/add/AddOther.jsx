...
import {List, ListItem, Page, Navbar, ListButton, BlockTitle, Segmented, Button} from 'framework7-react';
import { useTranslation } from 'react-i18next';
import {Device} from "../../../../../common/mobile/utils/device";
import SvgIcon from '../../../../../common/mobile/lib/component/SvgIcon';
import IconPageBreakIos from '@ios-icons/icon-pagebreak.svg';
import IconPageBreakAndroid from '@android-icons/icon-pagebreak.svg';
import IconStringBreakIos from '@ios-icons/icon-stringbreak.svg';
import IconStringBreakAndroid from '@android-icons/icon-stringbreak.svg';
import IconSectionBreakIos from '@ios-icons/icon-sectionbreak.svg';
import IconSectionBreakAndroid from '@android-icons/icon-sectionbreak.svg';
import IconExpandDownAndroid from '@common-android-icons/icon-expand-down.svg';
import IconExpandUpAndroid from '@common-icons/icon-expand-up.svg';
...
import IconPageNumberIos from '@ios-icons/icon-pagenumber.svg';
import IconPageNumberAndroid from '@android-icons/icon-pagenumber.svg';
