...
import { f7, View, List, ListItem, Button, Page, Navbar, NavRight, Segmented, BlockTitle, Link } from 'framework7-react';
...
import IconBullets from '@common-ios-icons/icon-bullets.svg';
import IconLineSpacing from '@common-ios-icons/icon-linespacing.svg';
